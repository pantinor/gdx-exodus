...
public interface Constants {
    ...
    public enum TileRule {
        ...
        poison(TileAttrib.dispelable.getVal(), TileSpeed.VVSLOW, TileEffect.POISON),
        energy(TileAttrib.dispelable.getVal() | TileAttrib.unflyable.getVal() | TileAttrib.unwalkable.getVal() | TileAttrib.creatureunwalkable.getVal(), TileSpeed.VVSLOW, TileEffect.ELECTRICITY),
        fire(TileAttrib.dispelable.getVal(), TileSpeed.VVSLOW, TileEffect.FIRE),
