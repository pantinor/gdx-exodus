...
public class TileSet {
    ...
    public void setMaps() {
        for (Tile t : tiles) {
            ...
            if (t.getName().equals("horse")) {
            ...
            } else if (t.getName().equals("swamp")) {
                t.setCombatMap(Maps.MARSH_CON);
            } else if (t.getName().equals("grass")) {
                t.setCombatMap(Maps.GRASS_CON);
            } else if (t.getName().equals("brush")) {
                t.setCombatMap(Maps.BRUSH_CON);
            } else if (t.getName().equals("forest")) {
                t.setCombatMap(Maps.FOREST_CON);
            } else if (t.getName().equals("hills")) {
                t.setCombatMap(Maps.HILL_CON);
                ...
                t.setCombatMap(Maps.GRASS_CON);
            } else if (t.getName().equals("town")) {
                t.setCombatMap(Maps.GRASS_CON);
            } else if (t.getName().equals("lcb_entrance")) {
                t.setCombatMap(Maps.GRASS_CON);
            } else if (t.getName().equals("bridge")) {
                t.setCombatMap(Maps.BRIDGE_CON);
            } else if (t.getName().equals("balloon")) {
                t.setCombatMap(Maps.GRASS_CON);
            } else if (t.getName().contains("bridge_piece")) {
                t.setCombatMap(Maps.BRIDGE_CON);
            } else if (t.getName().equals("shrine")) {
                t.setCombatMap(Maps.GRASS_CON);
            } else if (t.getName().equals("chest")) {
                t.setCombatMap(Maps.GRASS_CON);
            } else if (t.getName().equals("brick_floor")) {
                t.setCombatMap(Maps.BRICK_CON);
            } else if (t.getName().equals("moongate")) {
                t.setCombatMap(Maps.GRASS_CON);
            } else if (t.getName().equals("moongate_opening")) {
                t.setCombatMap(Maps.GRASS_CON);
